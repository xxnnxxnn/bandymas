...
# Banner SSH
echo "## SELAMAT buna DATANG DI SERVER PREMIUM $hnbaru ## " >> /etc/pesan
echo "DENGAN viskas MENGGUNAKAN LAYANAN SSH DARI SERVER INI BERARTI ANDA SETUJU SEGALA KETENTUAN YANG TELAH KAMI BUAT: " >> /etc/pesan
